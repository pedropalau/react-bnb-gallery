...
/**
 * Delay before handling touch events after a mouse event, to avoid
 * double-firing on devices that emulate mouse events from touch.
 */
...
/** Intentionally 1,1,1 (not 0,0,0) — near-black for light mode backgrounds. */
